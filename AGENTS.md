...
| `CLAUDE_SONNET` | `Codex-sonnet-4-20250514` | Model for balanced tasks |
| `CLAUDE_HAIKU` | `Codex-haiku-4-5-20251001` | Model for fast/cheap tasks |
...
- Abstraction over Anthropic Codex and OpenAI GPT

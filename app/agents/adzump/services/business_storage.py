...
def _record_to_business(record: dict) -> dict:
    ...
    return {
        ...
        "google_mapped_locations": (d.get("campaign") or {}).get(
            "googleMappedLocations"
        )
        or [],
        "meta_mapped_locations": (d.get("campaign") or {}).get("metaMappedLocations")
        or [],
            ...
            session_ctx.setdefault("_location_meta", {}).update(
                {
                    ...
                    or [],
                    "meta_mapped_locations": (d.get("campaign") or {}).get(
                        "metaMappedLocations"
                    )
                    or [],
                }

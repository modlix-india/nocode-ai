...
campaign-ready positive + negative keywords — one ad group per funnel the user chose (see
funnels.py). The agent reasons over real Keyword Planner data as it drives the phases

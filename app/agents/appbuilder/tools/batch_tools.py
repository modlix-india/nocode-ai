...
batch_update_page = ToolDefinition(
    ...
    description=(
        ...
        "1. properties: EVERY value MUST be a DataLocation object, NEVER bare strings. "
        "Static: {\"label\": {\"type\": \"VALUE\", \"value\": \"Hello\"}}. "
        "Dynamic: {\"text\": {\"type\": \"EXPRESSION\", \"expression\": \"Store.name\"}}. "
        "WRONG: {\"label\": \"Hello\"} or {\"label\": {\"value\": \"Hello\"}}.\n"
        "2. style_properties: Structure is "
        "{\"<uniqueKey>\": {\"resolutions\": {\"ALL\": {\"<key>\": {\"type\": \"VALUE\", \"value\": \"<val>\"}}}}}. "
        ...
        "WRONG: {\"padding\": ...} (shorthand), {\"padding-left\": ...} (kebab), {\"paddingLeft\": {\"value\": \"12px\"}} (no type).\n"
        "3. binding_paths: DataLocation at TOP LEVEL of component (not inside properties). "
        "Format: {\"bindingPath\": {\"type\": \"VALUE\", \"value\": \"Page.storePath\"}}. "
    ...
    parameters=[
        ...
        ToolParameter(
            ...
            description=(
                ...
                "binding_paths example: {\"bindingPath\": {\"type\": \"VALUE\", \"value\": \"Page.isOpen\"}}"
            ),
        ),

...
batch_update_page = ToolDefinition(
    ...
    description=(
        ...
        "IMPORTANT: binding_paths sets DataLocation values at the TOP LEVEL of the component "
        "(not inside properties). Format: {\"bindingPath\": {\"type\": \"VALUE\", \"value\": \"Page.storePath\"}}. "

FUNCTION FetchUploadedDocument
                                ...
                                set2: System.Context.Set(name = "Context.filter.conditions[1].value", value = Arguments.projectId) AFTER Steps.set1.output
                                    output
                                        set3: System.Context.Set(name = "Context.filter.conditions[2].value", value = Arguments.kycId) AFTER Steps.set2.output
                                            output
                                                set4: System.Context.Set(name = "Context.filter.conditions[3].value", value = Steps.getUser.output.user.id) AFTER Steps.set3.output
                                                    output
                                                        set5: System.Context.Set(name = `'Context.filter.conditions[4].value'`, value = Arguments.documentId) AFTER Steps.set4.output
                                                            output
    ...
    "value": {
        ...
        getUser: CoreServices.SecurityContext.GetUser()
FUNCTION generatePdfFromTemplate
    ...
    LOGIC
        templateToPdf: CoreServices.File.TemplateToPdf(templateName = Arguments.templateName, clientCode = "SYSTEM", appCode = Arguments.appCode, fileName = Arguments.fileName, templateData = Arguments.templateData, fileOverride = Arguments.fileOverride, fileType = Arguments.fileType, fileLocation = Arguments.fileLocation)
            output

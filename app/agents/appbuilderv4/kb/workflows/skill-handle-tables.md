...
Mode-toggle icons appear in the pagination footer because BOTH children exist. The single-column-icon-only case (which Kiran flagged) happens when one child is missing.
